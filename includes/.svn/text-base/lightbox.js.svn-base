...
//	Configuration
//
var fileLoadingImage = "../img/loading.gif";				// Loading image		
var fileBottomNavCloseImage = "../img/closelabel.gif";		// Close image
var fallbackOverlayImage = "../img/overlay.png";			// Fallback overlay used with browsers that have opacity problems
